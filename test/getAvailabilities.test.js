...
describe("getAvailabilities", () => {
  ...
  describe("weekly recurring openings", () => {
    ...
    // new added test case
    it("weekly after 2 weeks recurring are recurring", async () => {
      await knexClient("events").insert([
        {
          kind: "opening",
          starts_at: new Date("2020-01-01 14:00").toISOString(),
      ...
      availabilities = await getAvailabilities(new Date("2020-01-15 00:00"));
      expect(availabilities["2020-01-15"]).toEqual(["14:00"]);
    });
